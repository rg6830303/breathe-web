...
//
// All files live in /public/photos. Five court shots ship with the repo; the
// five "community" shots below must be dropped into /public/photos with these
// exact filenames (they are wired up everywhere already):
//
//   community-women.png     — group of players on the floodlit court at night
//   players-action.png      — two players mid-rally on the blue court
//   community-court.png     — friends courtside at dusk, paddles in hand
//   breathe-kitchen.png     — the courtside "Breathe Kitchen" cafe counter
...
export const photos = {
  ...
  // ── Added by the owner ───────────────────────────────────────────────
  communityWomen: P("community-women.png", "A group of players courtside under the floodlights", "portrait"),
  playersAction: P("players-action.png", "Two players mid-rally on the blue court", "portrait"),
  communityCourt: P("community-court.png", "Friends courtside at dusk with their paddles", "portrait"),
  kitchen: P("breathe-kitchen.png", "The courtside Breathe Kitchen cafe counter", "portrait"),
